-- pillaged from containers Data.IntMap.Strict
...
module Data.BoundedRelativeFinder.Internal.IntMap (
    -- * Map type
...
--            don't have the mask bit set; right is all the elements that do.
              | Tip {-# UNPACK #-} !Key {-# UNPACK #-} !(UV.Vector Int)
              | Nil
...
(!?) :: IntMap -> Key -> Maybe (UV.Vector Int)
(!?) m k = lookup k m
...
-- | @since 0.5.7
instance Semigroup (IntMap) where
    (<>)    = union
    stimes  = stimesIdempotentMonoid
#endif

instance NFData (IntMap) where
    rnf Nil = ()
    rnf (Tip _ v) = rnf v
...
notMember :: Key -> IntMap -> Bool
notMember k m = not $ member k m

-- | /O(min(n,W))/. Lookup the value at a key in the map. See also 'Data.Map.lookup'.

-- See Note: Local 'go' functions and capturing]
lookup :: Key -> IntMap -> Maybe (UV.Vector Int)
lookup !k = go
  where
...
-- See Note: Local 'go' functions and capturing]
findWithDefault :: (UV.Vector Int) -> Key -> IntMap -> (UV.Vector Int)
...
-- See Note: Local 'go' functions and capturing.
lookupLT :: Key -> IntMap -> Maybe (Key, (UV.Vector Int))
...
-- See Note: Local 'go' functions and capturing.
lookupGT :: Key -> IntMap -> Maybe (Key, (UV.Vector Int))
...
-- See Note: Local 'go' functions and capturing.
lookupLE :: Key -> IntMap -> Maybe (Key, (UV.Vector Int))
...
-- See Note: Local 'go' functions and capturing.
lookupGE :: Key -> IntMap -> Maybe (Key, (UV.Vector Int))
...
-- given, it has m > 0.
unsafeFindMin :: IntMap -> Maybe (Key, (UV.Vector Int))
...
-- given, it has m > 0.
unsafeFindMax :: IntMap -> Maybe (Key, (UV.Vector Int))
...
singleton :: Key -> (UV.Vector Int) -> IntMap
singleton k x
  = Tip k x
{-# INLINE singleton #-}
...
insert :: Key -> (UV.Vector Int) -> IntMap -> IntMap
...
insertWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> Key -> (UV.Vector Int) -> IntMap -> IntMap
insertWith f k x t
...
insertWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> Key -> (UV.Vector Int) -> IntMap -> IntMap
...
insertLookupWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> Key -> (UV.Vector Int) -> IntMap -> (Maybe (UV.Vector Int), IntMap)
...
adjust ::  ((UV.Vector Int) -> (UV.Vector Int)) -> Key -> IntMap -> IntMap
adjust f k m
...
adjustWithKey ::  (Key -> (UV.Vector Int) -> (UV.Vector Int)) -> Key -> IntMap -> IntMap
...
update ::  ((UV.Vector Int) -> Maybe (UV.Vector Int)) -> Key -> IntMap -> IntMap
update f
...
updateWithKey ::  (Key -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> Key -> IntMap -> IntMap
...
updateLookupWithKey ::  (Key -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> Key -> IntMap -> (Maybe (UV.Vector Int),IntMap)
...
alter :: (Maybe (UV.Vector Int) -> Maybe (UV.Vector Int)) -> Key -> IntMap -> IntMap
...
alterF :: Functor f
       => (Maybe (UV.Vector Int) -> f (Maybe (UV.Vector Int))) -> Key -> IntMap -> f (IntMap)
...
unions :: Foldable f => f (IntMap) -> IntMap
unions xs
...
unionsWith :: Foldable f => ((UV.Vector Int)->(UV.Vector Int)->(UV.Vector Int)) -> f (IntMap) -> IntMap
unionsWith f ts
...
unionWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
unionWith f m1 m2
...
unionWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
unionWithKey f m1 m2
  = mergeWithKey' Bin (\(Tip k1 x1) (Tip _k2 x2) -> let z = f k1 x1 x2 in z `seq` Tip k1 z) id id m1 m2
...
difference :: IntMap -> IntMap -> IntMap
difference m1 m2
...
differenceWith :: ((UV.Vector Int) -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
...
differenceWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
...
--
-- @since 0.5.8
withoutKeys :: IntMap -> IntSet.IntSet -> IntMap
...
updatePrefix
    :: IntSetPrefix -> IntMap -> (IntMap -> IntMap) -> IntMap
...
withoutBM :: IntSetBitMap -> IntMap -> IntMap
withoutBM 0 t = t
...
intersection :: IntMap -> IntMap -> IntMap
intersection m1 m2
...
--
-- @since 0.5.8
restrictKeys :: IntMap -> IntSet.IntSet -> IntMap
...
-- a key prefix.
lookupPrefix :: IntSetPrefix -> IntMap -> IntMap
...
restrictBM :: IntSetBitMap -> IntMap -> IntMap
restrictBM 0 _ = Nil
...
intersectionWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
...
intersectionWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap -> IntMap
...
mergeWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> (IntMap -> IntMap) -> (IntMap -> IntMap)
             -> IntMap -> IntMap -> IntMap
...
mergeWithKey' :: (Prefix -> Mask -> IntMap -> IntMap -> IntMap)
              -> (IntMap -> IntMap -> IntMap) -> (IntMap -> IntMap) -> (IntMap -> IntMap)
              -> IntMap -> IntMap -> IntMap
...
filterWithKeyA
  :: Applicative f => (Key -> (UV.Vector Int) -> f Bool) -> IntMap -> f (IntMap)
...
-- @since 0.6.4
traverseMaybeWithKey
  :: Applicative f => (Key -> (UV.Vector Int) -> f (Maybe (UV.Vector Int))) -> IntMap -> f (IntMap)
...
updateMinWithKey :: (Key -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap
...
updateMaxWithKey :: (Key -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap
...
data View = View {-# UNPACK #-} !Key {-# UNPACK #-} !(UV.Vector Int) !(IntMap)
...
maxViewWithKey :: IntMap -> Maybe ((Key, (UV.Vector Int)), IntMap)
...
maxViewWithKeySure :: IntMap -> View
...
minViewWithKey :: IntMap -> Maybe ((Key, (UV.Vector Int)), IntMap)
minViewWithKey t =
  case t of
    Nil -> Nothing
...
minViewWithKeySure :: IntMap -> View
...
updateMax :: ((UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap
...
deleteFindMax :: IntMap -> ((Key, (UV.Vector Int)), IntMap)
...
-- if the map may be empty.
deleteFindMin :: IntMap -> ((Key, (UV.Vector Int)), IntMap)
...
lookupMin :: IntMap -> Maybe (Key, (UV.Vector Int))
...
findMin :: IntMap -> (Key, (UV.Vector Int))
findMin t
...
lookupMax :: IntMap -> Maybe (Key, (UV.Vector Int))
...
findMax :: IntMap -> (Key, (UV.Vector Int))
findMax t
...
isProperSubmapOf :: IntMap -> IntMap -> Bool
...
{- | /O(n+m)/. Is this a proper submap? (ie. a submap but not equal).
 ...
 But the following are all 'False':
  ...
  > isProperSubmapOfBy (<)  (fromList [(1,1)])       (fromList [(1,1),(2,2)])
-}
isProperSubmapOfBy :: ((UV.Vector Int) -> (UV.Vector Int) -> Bool) -> IntMap -> IntMap -> Bool
isProperSubmapOfBy predicate t1 t2
  = case submapCmp predicate t1 t2 of
      LT -> True
      _  -> False

submapCmp :: ((UV.Vector Int) -> (UV.Vector Int) -> Bool) -> IntMap -> IntMap -> Ordering
...
-}
isSubmapOfBy :: (UV.Vector Int -> UV.Vector Int -> Bool) -> IntMap -> IntMap -> Bool
...
map :: ((UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap
map f = go
  where
...
mapWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int)) -> IntMap -> IntMap
mapWithKey f t
  = case t of
...
traverseWithKey :: Applicative t => (Key -> (UV.Vector Int) -> t (UV.Vector Int)) -> IntMap -> t (IntMap)
...
mapAccum :: (a -> (UV.Vector Int) -> (a,(UV.Vector Int))) -> a -> IntMap -> (a,IntMap)
...
mapAccumWithKey :: (a -> Key -> (UV.Vector Int) -> (a,(UV.Vector Int))) -> a -> IntMap -> (a,IntMap)
mapAccumWithKey f a t
  = mapAccumL f a t

-- | /O(n)/. The function @'mapAccumL'@ threads an accumulating
-- argument through the map in ascending order of keys.
mapAccumL :: (a -> Key -> (UV.Vector Int) -> (a,(UV.Vector Int))) -> a -> IntMap -> (a,IntMap)
mapAccumL f a t
  = case t of
      Bin p m l r
        | m < 0 ->
...
mapAccumRWithKey :: (a -> Key -> (UV.Vector Int) -> (a,(UV.Vector Int))) -> a -> IntMap -> (a,IntMap)
...
mapKeysWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> (Key->Key) -> IntMap -> IntMap
mapKeysWith c f
...
mapKeysMonotonic :: (Key->Key) -> IntMap -> IntMap
mapKeysMonotonic f
...
filter :: ((UV.Vector Int) -> Bool) -> IntMap -> IntMap
filter p m
...
filterWithKey :: (Key -> (UV.Vector Int) -> Bool) -> IntMap -> IntMap
...
partition :: ((UV.Vector Int) -> Bool) -> IntMap -> (IntMap,IntMap)
partition p m
...
partitionWithKey :: (Key -> (UV.Vector Int) -> Bool) -> IntMap -> (IntMap,IntMap)
...
mapMaybe :: ((UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap
...
mapMaybeWithKey :: (Key -> (UV.Vector Int) -> Maybe (UV.Vector Int)) -> IntMap -> IntMap
...
mapEither :: ((UV.Vector Int) -> Either (UV.Vector Int) (UV.Vector Int)) -> IntMap -> (IntMap, IntMap)
mapEither f m
...
mapEitherWithKey :: (Key -> (UV.Vector Int) -> Either (UV.Vector Int) (UV.Vector Int)) -> IntMap -> (IntMap, IntMap)
...
split :: Key -> IntMap -> (IntMap, IntMap)
split k t =
  case t of
    Bin _ m l r
      | m < 0 ->
...
data SplitLookup = SplitLookup !(IntMap) !(Maybe (UV.Vector Int)) !(IntMap)

mapLT :: (IntMap -> IntMap) -> SplitLookup -> SplitLookup
mapLT f (SplitLookup lt fnd gt) = SplitLookup (f lt) fnd gt
{-# INLINE mapLT #-}

mapGT :: (IntMap -> IntMap) -> SplitLookup -> SplitLookup
...
splitLookup :: Key -> IntMap -> (IntMap, Maybe (UV.Vector Int), IntMap)
splitLookup k t =
  case
    case t of
      Bin _ m l r
...
foldr :: ((UV.Vector Int) -> b -> b) -> b -> IntMap -> b
...
foldl :: (a -> (UV.Vector Int) -> a) -> a -> IntMap -> a
...
foldrWithKey :: (Key -> (UV.Vector Int) -> b -> b) -> b -> IntMap -> b
...
foldlWithKey :: (a -> Key -> (UV.Vector Int) -> a) -> a -> IntMap -> a
...
--
-- @since 0.5.4
foldMapWithKey :: Monoid m => (Key -> (UV.Vector Int) -> m) -> IntMap -> m
foldMapWithKey f = go
  where
    go Nil           = mempty
    go (Tip kx x)    = f kx x
...
assocs :: IntMap -> [(Key,(UV.Vector Int))]
assocs = toAscList
...
fromSet :: (Key -> (UV.Vector Int)) -> IntSet.IntSet -> IntMap
...
#if __GLASGOW_HASKELL__ >= 708
-- | @since 0.5.6.2
instance GHCExts.IsList (IntMap) where
  type Item (IntMap) = (Key,UV.Vector Int)
  fromList = fromList
  toList   = toList
#endif
...
toList :: IntMap -> [(Key,(UV.Vector Int))]
toList = toAscList
...
toAscList :: IntMap -> [(Key,(UV.Vector Int))]
...
toDescList :: IntMap -> [(Key,(UV.Vector Int))]
...
foldrFB :: (Key -> (UV.Vector Int) -> b -> b) -> b -> IntMap -> b
foldrFB = foldrWithKey
{-# INLINE[0] foldrFB #-}
foldlFB :: (a -> Key -> (UV.Vector Int) -> a) -> a -> IntMap -> a
...
fromList :: [(Key,(UV.Vector Int))] -> IntMap
fromList xs
...
fromListWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> [(Key,(UV.Vector Int))] -> IntMap
fromListWith f xs
...
fromListWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> [(Key,(UV.Vector Int))] -> IntMap
...
fromAscList :: [(Key,(UV.Vector Int))] -> IntMap
...
fromAscListWith :: ((UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> [(Key,(UV.Vector Int))] -> IntMap
...
fromAscListWithKey :: (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> [(Key,(UV.Vector Int))] -> IntMap
...
fromDistinctAscList :: [(Key,(UV.Vector Int))] -> IntMap
...
fromMonoListWithKey :: Distinct -> (Key -> (UV.Vector Int) -> (UV.Vector Int) -> (UV.Vector Int)) -> [(Key,(UV.Vector Int))] -> IntMap
...
data Inserted = Inserted !(IntMap) ![(Key,(UV.Vector Int))]
...
{--------------------------------------------------------------------
  Eq
--------------------------------------------------------------------}
instance  Eq (IntMap) where
  t1 == t2  = equal t1 t2
  t1 /= t2  = nequal t1 t2

equal ::  IntMap -> IntMap -> Bool
...
{--------------------------------------------------------------------
  Link
--------------------------------------------------------------------}
link :: Prefix -> IntMap -> Prefix -> IntMap -> IntMap
...
linkWithMask :: Mask -> Prefix -> IntMap -> IntMap -> IntMap
...
--------------------------------------------------------------------}
bin :: Prefix -> Mask -> IntMap -> IntMap -> IntMap
bin _ _ l Nil = l
bin _ _ Nil r = r
...
-}
showTreeWith :: Bool -> Bool -> IntMap -> String
showTreeWith hang wide t
  | hang      = (showsTreeHang wide [] t) ""
  | otherwise = (showsTree wide [] [] t) ""

showsTree ::  Bool -> [String] -> [String] -> IntMap -> ShowS
...
showsTreeHang ::  Bool -> [String] -> IntMap -> ShowS
